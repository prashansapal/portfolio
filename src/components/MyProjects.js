    ...
    <section id="myprojects" className="myprojects">
      ...
      <div className="myprojects-grid">
        <div className="myproj-card">
          ...
          <a href="https://www.figma.com/design/Fv3sPuf9U09AaPsDXY8N44/TasteTreatFinal?node-id=14-2782&p=f&t=mfmgiLovB0v9JxYm-0" target="_blank" rel="noopener noreferrer" className="view-project-btn">View in Figma</a>
        </div>
        ...
        <div className="myproj-card">
          ...
          <a href="https://www.figma.com/design/vmGdXJnX4zCXJ7GTiVkQ3e/NFTWebsite?node-id=3-45&p=f&t=dic5IPHjYNPsrREQ-0" target="_blank" rel="noopener noreferrer" className="view-project-btn">View in Figma</a>
        </div>
      </div>
    </section>
  );
